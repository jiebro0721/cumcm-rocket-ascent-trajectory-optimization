% 附录：完整源代码（自动生成，与仓库 src/ 与 cross_validation/ 完全一致）
...
\section{问题一基准控制策略全程仿真 q1\_baseline.py}
\begin{lstlisting}[language=Python]
...
\section{问题二入轨条件有界三维打靶 q2\_inscription.py}
\begin{lstlisting}[language=Python]
...
\section{交叉验证独立实现 rocket\_trajectory\_solution.py}
\begin{lstlisting}[language=Python]
